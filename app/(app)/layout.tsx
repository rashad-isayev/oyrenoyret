    ...
    <AppShell
      ...
      user={{
        ...
        guidelinesAcceptedAt: user.guidelinesAcceptedAt
          ? user.guidelinesAcceptedAt.toISOString()
          : null,
        guidelinesVersion: user.guidelinesVersion,
        accountOwnerType: user.accountOwnerType,
        tutorialCompletedAt: user.tutorialCompletedAt
          ? user.tutorialCompletedAt.toISOString()
          : null,
        tutorialSkippedAt: user.tutorialSkippedAt
          ? user.tutorialSkippedAt.toISOString()
          : null,
